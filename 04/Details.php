...
echo" <body>";
echo "<hr>";
echo"<h1>";echo "Match Details";echo"</h1>";
...
//output rows for details table. 
  echo "<tr><th>"; echo "Event Name"; echo" </th><td>"; echo $rows['EVENT']; echo "</td></tr>";
  echo "<tr><th>"; echo "Event Site"; echo" </th><td>"; echo $rows['site']; echo "</td></tr>"; 
  echo "<tr><th>"; echo "Date"; echo" </th><td>"; echo $dateOfMatch; echo "</td></tr>"; 
  echo "<tr><th>"; echo "Round Number"; echo" </th><td>"; echo $rows['round']; echo "</td></tr>"; 
  echo "<tr><th>"; echo "Player One"; echo" </th><td>"; echo $rows['player1']; echo "</td></tr>"; 
  echo "<tr><th>"; echo "Player Two"; echo" </th><td>"; echo $rows['player2']; echo "</td></tr>"; 
  echo "<tr><th>"; echo "Result"; echo" </th><td>"; echo $result; echo "</td></tr>"; 
  echo "<tr><th>"; echo "Eco and Opening"; echo" </th><td>"; echo $rows['eco'].", ".$rows['opening']; echo "</td></tr>"; 
  echo "<tr><th style = 'text-align:center'>"; echo "Moves"; echo "<img src= "; echo "'chessPiece.jpg' alt='' border='3' height='65' width='57'"; echo "/>"; echo" </th><td>"; echo $rows['moves']; echo "</td></tr>";
}
